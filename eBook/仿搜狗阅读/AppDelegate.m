...
static NSString * const LYBookShelfStoryboardID = @"LYBookShelfStoryboardID";
...
- (LYBookShelfVCViewController *)bookshelfViewController {
    if (!_bookshelfViewController) {
//        _bookshelfViewController = [self.drawersStoryboard instantiateViewControllerWithIdentifier:YTBookstoreStoryboardID];//原书架
        _bookshelfViewController = [self.drawersStoryboard instantiateViewControllerWithIdentifier:LYBookShelfStoryboardID];//自定义
...
//    config.baseUrl = @"http://120.76.99.94:8080/ReadPaper/";
    config.baseUrl = @"https://testzswpapi.1889.com/index.php";
    config.cdnUrl = @"http://fen.bi";

    //http://120.76.99.94:8080/ReadPaper/GetMagazineCategories
}
